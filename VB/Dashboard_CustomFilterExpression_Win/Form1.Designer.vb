...
'ORIGINAL LINE: this.dashboardViewer1.CustomFilterExpression += new DevExpress.DataAccess.CustomFilterExpressionEventHandler(this.dashboardViewer1_CustomFilterExpression);
			' 
			' Form1
			' 
